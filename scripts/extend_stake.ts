...
async function main() {
  ...
  const mint = new PublicKey('413HxKyXfZhYscc5Bq7nHoWPc28ZMV7HXMSSuEVX1TB6'); // Replace with your mint public key
  ...
  // Define the duration to extend
  const duration = new BN(60000); // Replace with the duration to extend in seconds

  // Create the extend transaction
